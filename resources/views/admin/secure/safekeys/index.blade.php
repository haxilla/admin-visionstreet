  ...
  :class="collapsed ? 'ml-20' : 'ml-64'">
    <div class="ml-8 mr-8 lg:ml-10 lg:mr-10">
			<div class="flex items-center justify-between mb-6">
			    ...
			    <a href="#"
			        class="inline-flex items-center border border-blue-900 bg-white text-blue-900 font-medium py-1 px-3 rounded-sm shadow-sm transition-colors duration-200 text-sm
			               hover:bg-blue-900 hover:text-white">
			        <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5 mr-1 text-blue-900 hover:text-white transition-colors duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
