    ...
    {{-- Logo with no padding and full height --}}
     <div class="flex items-center px-6 py-2 h-full">
        <a href="/super/dashboard"
           class="logo-lightning group flex items-center gap-2 text-2xl uppercase font-orbitron tracking-widest text-yellow-400 relative select-none">
            <svg class="w-5 h-5 text-yellow-400 group-hover:text-white transition duration-150" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                 viewBox="0 0 24 24">
