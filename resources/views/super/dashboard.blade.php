...
isOpen(route) {return this.activeDropdown === route;}}">
  ...
  x-cloak
  class="transition-all duration-200 ease-in-out transform origin-top opacity-0 scale-95"
  :class="isOpen(section.route) ? 'opacity-100 scale-100' : 'opacity-0 scale-95'"
